...
__all__ = [
    'SPCATEGORYTYPE', 'DISPID_SpeechPhraseInfo',
    'SWPUnknownWordUnpronounceable', 'DISPID_SVSRunningState',
    'ISpeechLexiconPronunciations', 'SDTAudio',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SLOStatic',
    'DISPID_SGRSTPropertyName', 'DISPID_SpeechPhraseRule',
    'SPRST_INACTIVE_WITH_PURGE', 'SRSEIsSpeaking', 'ISpRecoCategory',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SGRAttributes',
    'SAFTCCITT_ALaw_22kHzMono', 'ISpeechRecoResultDispatch',
    'DISPID_SLPs_NewEnum', 'SpeechAllElements', 'SVP_14',
    'SPEI_RESERVED6', 'SpSharedRecognizer',
    'DISPID_SVESentenceBoundary', 'SpeechVoiceEvents',
    'SAFT11kHz16BitMono', 'SPWORDPRONUNCIATIONLIST',
    'SRSActiveAlways', 'SP_VISEME_1', 'DISPID_SLPLangId',
    'SpeechBookmarkOptions', 'SPSLMA', 'ISpRecoResult',
    'SVSFParseAutodetect', 'DISPID_SGRInitialState',
    'SpResourceManager', 'SVP_7', 'eLEXTYPE_PRIVATE7',
    'ISequentialStream', 'DISPID_SRRAudio', 'SPRS_INACTIVE',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVSInputSentenceLength', 'DISPID_SpeechRecoContext',
    'DISPID_SPPEngineConfidence', 'DISPID_SDKOpenKey',
    'ISpeechWaveFormatEx', 'ISpeechAudio',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpeechAudioFormatType',
    'eLEXTYPE_MORPHOLOGY', 'SREFalseRecognition', 'SAFTDefault',
    'SpeechDataKeyLocation', 'DISPID_SOTGetAttribute',
    'eLEXTYPE_PRIVATE19', 'SPEI_RESERVED1',
    'DISPID_SRCRequestedUIType', 'SpeechGrammarTagWildcard',
    'SPCT_SLEEP', 'DISPID_SDKSetLongValue',
    'DISPID_SGRSAddSpecialTransition', 'ISpPhoneticAlphabetConverter',
    'SAFT24kHz8BitStereo', 'eLEXTYPE_RESERVED6',
    'DISPID_SPARecoResult', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPPS_SuppressWord', 'DISPID_SVStatus', 'DISPID_SPAs_NewEnum',
    'DISPID_SPEDisplayAttributes', 'DISPID_SVIsUISupported',
    'DISPID_SRCERecognition', 'SAFTText',
    'DISPID_SPEAudioStreamOffset', 'SDTLexicalForm',
    'SpeechSpecialTransitionType', 'DISPID_SRGCmdSetRuleState',
    'ISpeechPhraseElements', 'DISPID_SVEAudioLevel',
    'DISPID_SPPsItem', 'SpeechRecoProfileProperties',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRGCmdLoadFromObject',
    'SPEVENT', 'ISpeechGrammarRule',
    'SpeechPropertyNormalConfidenceThreshold', 'SPRS_ACTIVE',
    'SP_VISEME_16', 'SPINTERFERENCE_TOOLOUD',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPEI_REQUEST_UI',
    'DISPID_SRGCmdLoadFromResource', 'SRTEmulated',
    'DISPID_SASNonBlockingIO', 'SPPS_Function', 'SPEI_SR_PRIVATE',
    'DISPID_SLPType', 'DISPID_SPIStartTime', 'SDKLDefaultLocation',
    'DISPID_SpeechWaveFormatEx', 'SPFM_OPEN_READONLY',
    'DISPID_SpeechObjectTokenCategory', 'SPAS_STOP',
    'Speech_Default_Weight', 'eWORDTYPE_ADDED', 'SAFT12kHz8BitStereo',
    'tagSPPROPERTYINFO', 'SPRST_ACTIVE', 'SAFTCCITT_ALaw_8kHzMono',
    'SGPronounciation', 'SPDKL_DefaultLocation', 'SPPHRASE',
    'SAFTGSM610_8kHzMono', 'SDA_Two_Trailing_Spaces',
    'DISPID_SRRTStreamTime', 'SAFT44kHz16BitStereo', 'SRSActive',
    'SpeechPropertyHighConfidenceThreshold', 'SPPS_Noncontent',
    'DISPID_SRCEBookmark', 'DISPID_SpeechCustomStream',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SOTCGetDataKey',
    'SVP_13', 'SPLO_STATIC', 'DISPID_SRCState', 'SVP_12',
    'ISpeechVoice', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'eLEXTYPE_PRIVATE8', 'SECFNoSpecialChars', 'STSF_AppData',
    'DISPID_SOTRemoveStorageFileName',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SLPsCount',
    'eLEXTYPE_PRIVATE20', 'DISPID_SVGetVoices', 'SRTAutopause',
    'DISPID_SRRTLength', 'SPSTREAMFORMATTYPE', 'SPSVerb', 'SVP_18',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechPhraseReplacements',
    'ISpRecoGrammar', 'DISPID_SPIReplacements', 'SLTApp',
    'DISPID_SPRuleChildren', 'DISPID_SPIRule', 'DISPID_SPRsItem',
    'DISPID_SVEBookmark', 'SPRECORESULTTIMES', 'SPRULESTATE',
    'SpPhoneConverter', 'SpeechAudioVolume',
    'DISPID_SpeechPhraseProperties', 'SPAUDIOBUFFERINFO',
    'SP_VISEME_5', 'SAFTADPCM_44kHzStereo', 'DISPID_SRRAlternates',
    'SVSFPurgeBeforeSpeak', 'DISPID_SRGetRecognizers',
    'SpInProcRecoContext', 'DISPID_SRGDictationSetState',
    'ISpObjectWithToken', 'DISPID_SPRulesItem',
    'SPINTERFERENCE_LATENCY_WARNING', 'Speech_Max_Word_Length',
    'ISpeechRecoResultTimes', 'SRADefaultToActive',
    'ISpeechRecognizer', 'DISPID_SPRuleName', 'SpeechTokenContext',
    'SREInterference', 'SAFT48kHz16BitStereo',
    'SDA_One_Trailing_Space', 'SSFMCreateForWrite',
    'DISPID_SPPConfidence', 'SPWF_INPUT', 'SPSModifier',
    'ISpPhraseAlt', 'DISPID_SpeechFileStream',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRCVoice',
    'DISPID_SVSkip', 'SVSFIsNotXML', 'SVEStartInputStream',
    'SPFM_NUM_MODES', 'SAFT12kHz8BitMono', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRCERequestUI', 'STSF_FlagCreate',
    'SPINTERFERENCE_TOOFAST', 'SPDKL_CurrentConfig',
    'DISPID_SPIGrammarId', 'SPVPRI_OVER', 'SPEI_RECOGNITION',
    'DISPID_SPIEngineId', 'SP_VISEME_20', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SFSOpen', 'SRAExport', 'DISPID_SRSClsidEngine',
    'SP_VISEME_14', 'DISPID_SPRDisplayAttributes', 'SPGRAMMARSTATE',
    'DISPID_SDKCreateKey', 'ISpeechXMLRecoResult',
    'SPINTERFERENCE_NONE', 'DISPID_SVVolume', 'SPPROPERTYINFO',
    'LONG_PTR', 'SPPS_Modifier', 'SPRST_NUM_STATES', 'SpFileStream',
    'SAFT12kHz16BitStereo', 'SRAONone', 'SVP_6', 'SPGS_ENABLED',
    'DISPID_SRCEAudioLevel', 'DISPID_SRIsShared',
    'SAFT24kHz16BitMono', 'DISPID_SPRuleEngineConfidence',
    'SpeechInterference', 'SREStateChange', 'SDTAlternates',
    'SVEPrivate', 'DISPID_SPIAudioSizeBytes', 'DISPID_SVEViseme',
    'SPSInterjection', 'SPCT_COMMAND', 'DISPID_SAEventHandle',
    'DISPID_SRCEFalseRecognition', 'SAFT11kHz16BitStereo',
    'DISPID_SpeechMMSysAudio', 'DISPID_SRCBookmark',
    'DISPID_SGRSTText', 'SPEVENTENUM', 'SGDSActiveWithAutoPause',
    'SPSHT_OTHER', 'SECFIgnoreKanaType', 'DISPID_SRGRules',
    'SAFTADPCM_8kHzStereo', 'DISPID_SLPPhoneIds',
    'DISPID_SGRSTsCount', 'DISPID_SOTCategory', 'ISpMMSysAudio',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SpeechVoiceEvent',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPRFirstElement',
    'SPEI_RESERVED5', 'ISpeechPhraseAlternate',
    'DISPID_SRRSaveToMemory', 'DISPID_SPIProperties',
    'DISPID_SAFGuid', 'DISPID_SRCEPhraseStart', 'SRCS_Disabled',
    'SAFTADPCM_11kHzStereo', 'ISpRecognizer2',
    'tagSPTEXTSELECTIONINFO', 'SpeechVoiceCategoryTTSRate',
    'ISpeechVoiceStatus', 'DISPID_SPAStartElementInResult',
    'SINoSignal', 'SVP_4', 'SPWT_PRONUNCIATION',
    'SpeechTokenKeyAttributes', 'DISPID_SBSFormat', 'DISPID_SVPause',
    'ISpeechGrammarRuleStateTransition', 'ISpeechPhraseRules',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SLPPartOfSpeech',
    'SPXRO_SML', '_ISpeechRecoContextEvents', 'SPRST_ACTIVE_ALWAYS',
    'SAFTCCITT_uLaw_11kHzMono', '_ISpeechVoiceEvents',
    'SpNotifyTranslator', 'ISpObjectTokenCategory', 'WAVEFORMATEX',
    'ISpRecoContext', 'SAFT11kHz8BitStereo', 'SPBO_NONE',
    'ISpeechRecoResult', 'SDTProperty', 'SPPS_Verb', 'SPPS_Unknown',
    'SpeechAddRemoveWord', 'SPGS_EXCLUSIVE', 'SpeechRuleState',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SGSEnabled',
    'eLEXTYPE_PRIVATE3', 'eLEXTYPE_PRIVATE16', 'SRESoundStart',
    'SGLexicalNoSpecialChars', 'DISPID_SREmulateRecognition',
    'SPFM_CREATE', 'DISPID_SPIGetText', 'DISPID_SRCSetAdaptationData',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpeechPhraseInfo',
    'DISPID_SpeechPhraseRules', 'DISPID_SpeechLexiconProns',
    'DISPID_SVSLastBookmark', 'DISPID_SpeechVoiceStatus', 'IStream',
    'SASRun', 'DISPID_SPPParent', 'SPEVENTSOURCEINFO', 'SVEViseme',
    'SLODynamic', 'SpeechVisemeType', 'DISPID_SDKSetStringValue',
    'ISpResourceManager', 'SPSHORTCUTTYPE',
    'DISPID_SRGIsPronounceable', 'SAFT48kHz16BitMono',
    'DISPID_SOTDataKey', 'DISPID_SGRsCount', 'DISPID_SOTsItem',
    'SpWaveFormatEx', 'SREHypothesis', 'SPEI_MAX_SR',
    'SVSFIsFilename', 'ISpSerializeState',
    'DISPID_SLAddPronunciation', 'SpMMAudioEnum', 'SPSUnknown',
    'SpUnCompressedLexicon', 'DISPID_SLAddPronunciationByPhoneIds',
    'ISpeechPhraseProperty', 'SPRULE', 'DISPID_SRRGetXMLErrorInfo',
    'SECNormalConfidence', 'SREAdaptation', 'SPSSuppressWord',
    'SPVPRIORITY', 'ISpRecognizer', 'SAFT22kHz8BitStereo',
    'SPBINARYGRAMMAR', 'SPAO_RETAIN_AUDIO', 'SPVPRI_ALERT',
    'SP_VISEME_21', 'SPEI_SOUND_END', 'SPEI_END_INPUT_STREAM',
    'SPCS_ENABLED', 'SPEI_PHONEME', 'DISPID_SRGetFormat',
    'DISPID_SRCEStartStream', 'SpAudioFormat',
    'DISPID_SLWPronunciations', 'SP_VISEME_9', 'DISPID_SVSVisemeId',
    'SP_VISEME_0', 'DISPID_SRGCommit', 'DISPID_SGRsCommitAndSave',
    'SAFT22kHz16BitMono', 'ISpeechFileStream',
    'SpObjectTokenCategory', 'DISPID_SPPs_NewEnum', 'SPEI_MAX_TTS',
    'DISPID_SPRs_NewEnum', 'SpeechStreamFileMode',
    'ISpeechGrammarRules', 'SPSHT_EMAIL', 'SPSHT_Unknown',
    'DISPID_SAVolume', 'SVP_15', 'DISPID_SPERequiredConfidence',
    'SPEI_TTS_BOOKMARK', 'SPBO_AHEAD', 'DISPID_SGRSTPropertyId',
    'DISPID_SRGReset', 'SPLEXICONTYPE', 'SAFT24kHz16BitStereo',
    'DISPID_SLGetPronunciations', 'DISPID_SLWs_NewEnum', 'SVPAlert',
    'SPEI_HYPOTHESIS', 'SWPKnownWordPronounceable',
    'SPFM_CREATE_ALWAYS', 'SGRSTTEpsilon', 'SPSNotOverriden',
    'DISPID_SOTIsUISupported', 'DISPID_SBSWrite', 'DISPID_SPAsCount',
    'DISPID_SVDisplayUI', 'DISPID_SPIAudioStreamPosition',
    'SAFTExtendedAudioFormat', 'DISPID_SRRGetXMLResult',
    'SpeechRecoEvents', 'DISPID_SPRuleFirstElement',
    'DISPID_SPCPhoneToId', 'ISpStream', 'SpeechTokenValueCLSID',
    'ISpRecoContext2', 'SPEI_TTS_AUDIO_LEVEL', 'SVEEndInputStream',
    'DISPID_SASState', 'SpNullPhoneConverter', 'eLEXTYPE_RESERVED8',
    'eLEXTYPE_PRIVATE5', 'DISPID_SRGDictationLoad',
    'SAFT44kHz16BitMono', 'DISPID_SRCERecognizerStateChange',
    'SRERecognition', 'DISPID_SOTsCount', 'SREPrivate',
    'DISPID_SRGId', 'ISpeechPhoneConverter', 'eLEXTYPE_PRIVATE11',
    'ISpeechLexiconWords', 'DISPID_SVSInputWordLength', 'SVP_1',
    'SpObjectToken', 'SpCompressedLexicon', 'SPPS_RESERVED2',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SGRClear',
    'DISPID_SABIEventBias', 'SPEI_PHRASE_START', 'DISPID_SPRText',
    'DISPID_SpeechAudioBufferInfo', 'ISpRecoGrammar2', 'SPPS_Noun',
    'DISPID_SVEEnginePrivate', 'SpeechAudioFormatGUIDWave',
    'UINT_PTR', '__MIDL_IWinTypes_0009', 'SVP_5',
    'DISPID_SVSPhonemeId', 'SPAR_Medium',
    'DISPID_SpeechPhraseElement', 'SVP_3', 'SpeechRegistryUserRoot',
    'ISpXMLRecoResult', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SGRSTsItem',
    'DISPID_SMSADeviceId', 'SWTAdded', 'DISPID_SRGState',
    'DISPID_SPERetainedStreamOffset', 'SpeechGrammarState',
    'ISpPhrase', 'SpLexicon', 'DISPID_SWFEAvgBytesPerSec',
    'ISpeechAudioBufferInfo', 'SpeechAudioState', 'SPPS_Interjection',
    'DISPID_SPEAudioSizeTime', 'DISPID_SRCRetainedAudio',
    'SPEI_INTERFERENCE', 'SpeechDisplayAttributes',
    'DISPID_SRCERecognitionForOtherContext', 'SPPHRASEREPLACEMENT',
    'DISPID_SGRSTRule', 'DISPID_SRGetPropertyNumber', 'tagSTATSTG',
    'DISPID_SRCEEndStream', 'DISPID_SGRAddState',
    'DISPID_SRRPhraseInfo', 'eLEXTYPE_PRIVATE2', 'SPDKL_LocalMachine',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRCPause',
    'DISPID_SpeechPhraseReplacements', 'SRSInactiveWithPurge',
    'DISPID_SLWWord', 'ISpeechRecoGrammar', 'DISPID_SMSGetData',
    'SPVISEMES', 'SRTExtendableParse',
    'SpeechPropertyComplexResponseSpeed', 'SPINTERFERENCE_NOSIGNAL',
    'ISpeechRecoResult2', 'SITooFast', 'DISPID_SRCEHypothesis',
    'SRARoot', 'SpeechTokenKeyFiles', 'SPSHT_NotOverriden',
    'SREStreamStart', 'SpeechCategoryRecoProfiles',
    'DISPID_SVAlertBoundary', 'SAFTADPCM_22kHzMono', 'SpeechRunState',
    'SPAO_NONE', 'DISPID_SLGetWords', 'SGDSInactive',
    'ISpNotifyTranslator', 'SPEI_VOICE_CHANGE', 'SVSFPersistXML',
    'SREPropertyStringChange', 'DISPID_SRDisplayUI', 'SGSExclusive',
    'SVP_0', 'ISpLexicon', 'ISpeechCustomStream',
    'SPTEXTSELECTIONINFO', 'SPEI_END_SR_STREAM', 'SVSFParseSapi',
    '_SPAUDIOSTATE', 'DISPID_SRSAudioStatus',
    'ISpeechPhraseInfoBuilder', 'SREAudioLevel',
    'DISPID_SpeechGrammarRules', 'SVEAudioLevel', 'SPINTERFERENCE',
    'DISPID_SVSInputWordPosition', 'DISPID_SCSBaseStream',
    'SPPS_RESERVED3', 'SPAUDIOSTATE', 'DISPID_SPEs_NewEnum',
    'SPVOICESTATUS', 'SVSFParseMask', 'DISPIDSPTSI_ActiveLength',
    'SPXRO_Alternates_SML', 'SPAR_Low', 'SREPhraseStart',
    'eLEXTYPE_APP', 'SPEI_TTS_PRIVATE', 'SPLOADOPTIONS',
    'SPPHRASEELEMENT', 'SpeechGrammarRuleStateTransitionType',
    'ISpeechPhraseReplacement', 'DISPID_SABufferInfo',
    'DISPID_SABIMinNotification', 'SDKLCurrentUser', 'SGRSTTWildcard',
    'SPLO_DYNAMIC', 'DISPID_SGRs_NewEnum', 'SPDATAKEYLOCATION',
    'DISPID_SpeechPhraseAlternates', 'SPWT_LEXICAL',
    'ISpGrammarBuilder', 'SVSFUnusedFlags', 'SSFMOpenForRead',
    'SP_VISEME_13', 'SpPhoneticAlphabetConverter', 'SDTReplacement',
    'SAFTADPCM_22kHzStereo', 'SASStop', 'SPSHORTCUTPAIR',
    'eLEXTYPE_RESERVED9', 'DISPID_SPPBRestorePhraseFromMemory',
    'ISpStreamFormatConverter', 'DISPID_SPEDisplayText',
    'SSSPTRelativeToCurrentPosition', 'SRERequestUI',
    'DISPID_SLWsCount', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRGetPropertyString', 'DISPID_SOTCDefault',
    'DISPID_SLWLangId', 'DISPID_SRCRecognizer',
    'ISpeechPhraseAlternates', 'DISPID_SPRuleConfidence',
    'SPEI_START_INPUT_STREAM', 'SpCustomStream', 'SVSFNLPSpeakPunc',
    'SITooQuiet', 'DISPID_SOTId', 'SpVoice', 'SAFT24kHz8BitMono',
    'SRTSMLTimeout', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SVSLastResult',
    'IEnumString', 'SpeechWordPronounceable', 'SpSharedRecoContext',
    'SVSFIsXML', 'SVSFNLPMask', 'DISPID_SVPriority', 'SPRST_INACTIVE',
    'ISpeechPhraseProperties', 'SPSFunction', 'SPCT_DICTATION',
    'SVP_16', 'SpPhraseInfoBuilder', 'SpeechEngineConfidence',
    'DISPID_SLGetGenerationChange', 'SAFT16kHz16BitMono',
    'DISPID_SpeechRecognizerStatus', 'SPWORD', 'SPSMF_UPS',
    'SVSFlagsAsync', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPEsItem',
    'SAFT32kHz8BitMono', 'SPEI_VISEME', 'DISPID_SVEventInterests',
    'DISPID_SWFEBitsPerSample', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPCLangId', 'SPPHRASEPROPERTY', 'SpMMAudioOut',
    'SpeechDiscardType', 'SRADynamic', 'DISPID_SpeechPhoneConverter',
    'SSTTTextBuffer', 'SAFTCCITT_uLaw_22kHzMono', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRStatus', 'SPSERIALIZEDRESULT', 'SECLowConfidence',
    'SAFTGSM610_22kHzMono', 'SPAUDIOOPTIONS', 'SP_VISEME_19',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SGRSRule',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SLPsItem',
    'SpeechPartOfSpeech', 'SAFTCCITT_uLaw_8kHzMono', 'SVP_8',
    'SpeechRecognizerState', 'DISPID_SOTCId', 'SWTDeleted',
    'SECFEmulateResult', 'DISPID_SGRsItem',
    'SpeechPropertyResourceUsage', 'STCInprocServer',
    'DISPID_SVWaitUntilDone', 'SSFMCreate', 'SECFIgnoreCase',
    'eLEXTYPE_PRIVATE14', 'SPEI_START_SR_STREAM',
    'eLEXTYPE_RESERVED10', 'SAFT22kHz8BitMono', 'STCRemoteServer',
    'SVP_11', 'DISPID_SRCCreateGrammar', 'DISPID_SADefaultFormat',
    'SPINTERFERENCE_NOISE', 'DISPID_SOTGetDescription',
    'ISpeechAudioFormat', 'SBOPause', 'DISPID_SPEAudioSizeBytes',
    'SpeechTokenIdUserLexicon', 'DISPID_SGRSTType', 'SITooSlow',
    'SPVPRI_NORMAL', 'SPEI_MIN_TTS', 'DISPID_SRSetPropertyString',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SPPsCount',
    'DISPID_SASetState', 'DISPID_SpeechObjectTokens',
    'DISPID_SWFEBlockAlign', 'SDA_No_Trailing_Space',
    'ISpeechLexiconPronunciation', 'DISPID_SRRDiscardResultInfo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRState',
    'SVF_None', 'SPXMLRESULTOPTIONS', 'SPEI_MIN_SR', 'SPFILEMODE',
    'DISPID_SGRSTransitions', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SDKDeleteValue', 'DISPID_SGRId', 'eLEXTYPE_VENDORLEXICON',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPPFirstElement',
    'ISpStreamFormat', 'ISpeechMMSysAudio',
    'DISPID_SpeechRecoResult2', 'DISPID_SPIGetDisplayAttributes',
    'SRATopLevel', 'DISPID_SPPName', 'DISPID_SVGetProfiles',
    'DISPID_SRCEInterference', 'DISPID_SRRAudioFormat', 'SRTReSent',
    'DISPIDSPTSI', 'SpeechRegistryLocalMachineRoot',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SLGenerationId', 'DISPID_SVRate',
    'DISPID_SpeechLexicon', 'Speech_StreamPos_RealTime',
    'SPRECOSTATE', 'ISpeechAudioStatus', 'ISpProperties',
    'SAFT22kHz16BitStereo', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPIElements', 'SpeechTokenShellFolder',
    'eLEXTYPE_PRIVATE1', 'DISPID_SRGCmdSetRuleIdState',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFTGSM610_44kHzMono',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpMMAudioIn', 'SVPOver',
    'SPWF_SRENGINE', 'SpeechCategoryAudioOut', 'SVP_20',
    'SPDKL_CurrentUser', 'SDA_Consume_Leading_Spaces',
    'SSSPTRelativeToEnd', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SVEStreamEnd',
    'ISpObjectToken', 'Speech_Max_Pron_Length', 'SpeechVisemeFeature',
    'DISPID_SPRuleId', 'STSF_CommonAppData',
    'DISPID_SpeechAudioFormat', 'SSTTDictation',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFT8kHz16BitMono',
    'SpeechCategoryAppLexicons', 'SPEI_SOUND_START',
    'ISpeechMemoryStream', 'SREAllEvents', 'SGRSTTTextBuffer',
    'DISPID_SGRsFindRule', 'DISPID_SpeechDataKey', 'ISpEventSource',
    'DISPID_SRRTimes', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SPILanguageId', 'eLEXTYPE_RESERVED7', 'SP_VISEME_7',
    'ISpeechRecoContext', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SpeechRecognizer', 'DISPID_SAFGetWaveFormatEx',
    'SREPropertyNumChange', 'SAFTADPCM_11kHzMono',
    'DISPID_SDKSetBinaryValue', 'SAFTADPCM_44kHzMono',
    'SAFT8kHz8BitMono', 'SpeechCategoryPhoneConverters',
    'DISPID_SVAudioOutputStream', 'DISPID_SPRules_NewEnum',
    'DISPID_SDKGetlongValue', 'SRCS_Enabled',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SDKEnumValues',
    'DISPID_SPACommit', 'SPPS_RESERVED1', 'SP_VISEME_11',
    'SAFT32kHz16BitStereo', 'SpeechRecognitionType',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SVSInputSentencePosition',
    'DISPID_SPELexicalForm', 'DISPID_SRCEventInterests',
    'DISPID_SRCEAdaptation', 'eLEXTYPE_PRIVATE13', 'DISPID_SAFType',
    'DISPID_SpeechGrammarRuleState', 'SpeechAudioFormatGUIDText',
    'DISPID_SDKEnumKeys', 'SDTPronunciation',
    'DISPID_SRSetPropertyNumber', 'SVP_2', 'SAFTCCITT_ALaw_44kHzMono',
    'SSSPTRelativeToStart', 'ISpeechTextSelectionInformation',
    'SPPS_NotOverriden', 'SpMemoryStream', 'SPWAVEFORMATTYPE',
    'SVSFParseSsml', 'SpeechVoiceSpeakFlags',
    'DISPID_SPRNumberOfElements', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SOTSetId', 'SVESentenceBoundary', 'eWORDTYPE_DELETED',
    'SP_VISEME_17', 'SPBO_TIME_UNITS', 'SVP_10',
    'DISPIDSPTSI_ActiveOffset', 'SAFTADPCM_8kHzMono',
    'DISPID_SLRemovePronunciation', 'ISpeechObjectTokenCategory',
    'SpeechPropertyResponseSpeed', 'SpeechCategoryVoices',
    'IEnumSpObjectTokens', 'SpeechEmulationCompareFlags',
    'SpInprocRecognizer', 'DISPID_SPCIdToPhone', 'SVP_9',
    'IInternetSecurityManager', 'eLEXTYPE_PRIVATE17',
    'SpeechLoadOption', 'SVSFVoiceMask', 'SAFT8kHz8BitStereo',
    'SRERecoOtherContext', 'DISPID_SWFEFormatTag', 'SFTSREngine',
    'DISPID_SPPId', 'SpeechRuleAttributes', 'SPEI_RECO_STATE_CHANGE',
    'SAFTCCITT_uLaw_8kHzStereo', 'SVSFDefault', 'SGRSTTDictation',
    'SP_VISEME_2', 'STCInprocHandler', 'DISPID_SDKGetStringValue',
    'SPPS_LMA', 'DISPID_SVEWord', 'SpeechLexiconType',
    'SAFT16kHz16BitStereo', 'SpeechGrammarWordType',
    'DISPID_SVGetAudioOutputs', 'ISpeechPhraseRule',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRProfile',
    'DISPID_SGRAddResource', 'DISPIDSPTSI_SelectionLength',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFT16kHz8BitStereo', 'SGDisplay', 'SPCT_SUB_COMMAND',
    'DISPID_SpeechAudio', 'SpeechRetainedAudioOptions',
    'ISpeechLexiconWord', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRCreateRecoContext', 'DISPID_SLWsItem',
    'DISPID_SDKDeleteKey', 'SVEPhoneme',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPAsItem',
    'SAFTCCITT_ALaw_11kHzMono', 'SpeechUserTraining', 'ISpDataKey',
    'SP_VISEME_4', 'SGLexical', 'SPEI_WORD_BOUNDARY',
    'DISPID_SpeechPhraseProperty', 'STSF_LocalAppData', 'SECFDefault',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SOTs_NewEnum',
    'DISPID_SVEPhoneme', 'DISPID_SpeechLexiconWords',
    'DISPID_SVResume', 'DISPID_SVSLastBookmarkId',
    'DISPID_SPRulesCount', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SOTCreateInstance', 'SPAR_Unknown',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SpeechPhraseAlternate', 'SVEVoiceChange',
    'DISPID_SPPChildren', 'DISPID_SOTMatchesAttributes',
    'DISPID_SVSCurrentStreamNumber', 'SPSEMANTICERRORINFO', 'SBONone',
    'SPAUDIOSTATUS', 'SAFT44kHz8BitMono', 'SpShortcut',
    'DISPID_SPRsCount', 'SPFM_OPEN_READWRITE', 'SASClosed',
    'SPBOOKMARKOPTIONS', '_RemotableHandle', 'SPCS_DISABLED',
    'DISPID_SRCESoundStart', 'SpeechRecoContextState',
    'ISpeechDataKey', 'ISpShortcut', 'DISPID_SABufferNotifySize',
    'DISPID_SLWType', 'eLEXTYPE_PRIVATE6', 'SAFT48kHz8BitStereo',
    'ISpeechGrammarRuleState', 'DISPIDSPRG', 'ISpVoice',
    'DISPID_SGRsCommit', 'DISPID_SMSAMMHandle', 'SAFT11kHz8BitMono',
    'eLEXTYPE_PRIVATE4', 'DISPID_SVSpeakStream', 'DISPID_SOTRemove',
    'DISPID_SpeechRecoResult', 'SAFT44kHz8BitStereo',
    'DISPID_SOTCSetId', 'DISPID_SAStatus', 'SPWORDPRONUNCIATION',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SLPSymbolic',
    'DISPID_SRGSetTextSelection', 'Speech_StreamPos_Asap', 'SDTAll',
    'DISPID_SPEEngineConfidence', 'SPSEMANTICFORMAT',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SpeechGrammarRule',
    'DISPID_SpeechVoice', 'SpeechVoiceSkipTypeSentence',
    'SP_VISEME_12', 'SpeechCategoryAudioIn', 'eLEXTYPE_USER',
    'DISPID_SABIBufferSize', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRAudioInput', 'SDKLLocalMachine', 'SAFT16kHz8BitMono',
    'DISPID_SpeechLexiconWord', 'SP_VISEME_18',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpRecognizer3',
    'SpeechAudioProperties', 'SRESoundEnd', 'SpeechWordType',
    'SpeechStreamSeekPositionType', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SRGSetWordSequenceData', 'SAFT32kHz8BitStereo',
    'SDTDisplayText', 'DISPID_SPEPronunciation',
    'DISPID_SVGetAudioInputs', 'eLEXTYPE_RESERVED4',
    'DISPID_SWFEChannels', 'SINone', 'SDTRule', 'SPSNoun',
    'SPGRAMMARWORDTYPE', 'DISPID_SVEStreamStart', 'SASPause',
    'SVF_Stressed', 'IInternetSecurityMgrSite', 'SVP_17',
    'DISPID_SVSpeak', 'DISPID_SpeechAudioStatus', 'ISpAudio',
    'SGRSTTWord', 'DISPID_SGRSTNextState',
    'DISPID_SGRSTPropertyValue', 'SpeechEngineProperties',
    'SPRECOGNIZERSTATUS', 'SP_VISEME_6', 'SPCONTEXTSTATE',
    'SAFTNonStandardFormat', 'DISPID_SVAudioOutput', 'SREBookmark',
    'SPEI_RESERVED3', 'SRAInterpreter', 'ISpNotifySource',
    'SGSDisabled', 'eLEXTYPE_LETTERTOSOUND', 'SpeechFormatType',
    'SPPHRASERULE', 'SAFTGSM610_11kHzMono',
    'DISPID_SRCVoicePurgeEvent', 'SVEBookmark',
    'DISPID_SRGDictationUnload', 'SSFMOpenReadWrite',
    'SGDSActiveUserDelimited', 'SpTextSelectionInformation',
    'SAFT8kHz16BitStereo', 'SWPUnknownWordPronounceable',
    'SPAS_PAUSE', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRAudioInputStream', 'DISPID_SRGRecoContext',
    'DISPID_SGRsAdd', 'SPEI_UNDEFINED', 'SVPNormal',
    'DISPID_SPEActualConfidence',
    'DISPID_SRCAudioInInterferenceStatus', 'SPGS_DISABLED',
    'ISpeechObjectToken', 'DISPID_SGRSTs_NewEnum',
    'SPWORDPRONOUNCEABLE', 'SpeechMicTraining', 'DISPID_SPRuleParent',
    'DISPID_SWFEExtraData', 'DISPID_SVEVoiceChange',
    'SpStreamFormatConverter', 'SAFT12kHz16BitMono',
    'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SRSInactive',
    'DISPID_SBSRead', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SOTDisplayUI', 'SVF_Emphasis', 'SP_VISEME_15',
    'DISPID_SpeechRecoContextEvents', 'SpeechGrammarTagDictation',
    'DISPID_SDKGetBinaryValue', 'SRAORetainAudio',
    'DISPID_SPAPhraseInfo', 'DISPID_SpeechObjectToken',
    'STCLocalServer', 'SpeechPropertyAdaptationOn',
    'ISpeechResourceLoader', 'SPBO_PAUSE', 'ISpPhoneConverter',
    'SpStream', 'DISPID_SpeechBaseStream', 'DISPID_SRRTTickCount',
    'SP_VISEME_10', 'SAFT32kHz16BitMono', 'SPEI_SR_RETAINEDAUDIO',
    'SPAS_RUN', 'ISpeechLexicon', 'DISPID_SGRSTWeight',
    'SPEI_SR_BOOKMARK', 'DISPID_SpeechPhraseElements',
    'SECFIgnoreWidth', 'SREStreamEnd',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SINoise', 'SRSEDone',
    'SAFT48kHz8BitMono', 'DISPID_SPISaveToMemory',
    'ISpeechPhraseElement', 'DISPID_SPEsCount', 'ISpEventSink',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SPPNumberOfElements',
    'DISPID_SPIAudioSizeTime', 'SVEAllEvents', 'DISPID_SGRName',
    'SPADAPTATIONRELEVANCE', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SMSALineId', 'SRAImport', 'SPAR_High',
    'SpeechDictationTopicSpelling', 'SPAS_CLOSED',
    'eLEXTYPE_PRIVATE18', 'SP_VISEME_8', 'SVP_19',
    'DISPID_SRRSetTextFeedback', 'SVP_21', 'DISPID_SRCESoundEnd',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPINTERFERENCE_TOOSLOW',
    'SECHighConfidence', 'SPSERIALIZEDPHRASE', 'SAFTNoAssignedFormat',
    'DISPID_SpeechMemoryStream', 'SPEI_ADAPTATION',
    'DISPID_SRCResume', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SVVoice',
    'DISPID_SGRsDynamic', 'ISpNotifySink', 'SPEI_RESERVED2',
    'SITooLoud', 'DISPID_SASFreeBufferSpace', 'SpeechTokenKeyUI',
    'eLEXTYPE_PRIVATE10', 'SpeechVoicePriority', 'ISpeechBaseStream',
    'ISpeechRecognizerStatus', 'SLTUser', 'SRTStandard',
    'DISPID_SFSClose', 'DISPID_SMSSetData', 'ISpeechObjectTokens',
    'SGRSTTRule', 'SVEWordBoundary', 'SPWT_DISPLAY',
    'SPCT_SUB_DICTATION', 'SpeechCategoryRecognizers',
    'DISPID_SRIsUISupported', 'SPWORDTYPE', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRSSupportedLanguages', 'DISPID_SGRSAddWordTransition',
    'SPPS_RESERVED4', 'SP_VISEME_3', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRRSpeakAudio', 'DISPID_SOTCEnumerateTokens',
    'SGDSActive', 'DISPID_SRRecognizer', 'SPPARTOFSPEECH',
    'DISPID_SRRRecoContext', 'SFTInput', 'DISPID_SPPValue',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRCEEnginePrivate', 'SPWORDLIST',
    'DISPID_SBSSeek', 'STCAll', 'SDKLCurrentConfig',
    'SPEI_PROPERTY_STRING_CHANGE', 'SSTTWildcard'
]
